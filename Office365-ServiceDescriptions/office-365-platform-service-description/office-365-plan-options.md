...
每個 Microsoft 365 或 Office 365 計畫都包含許多個別的服務，例如 Exchange Online 和 SharePoint 線上。 下表顯示每個方案中可用的服務。
  
> [!IMPORTANT]
>  雖然服務可用於 Microsoft 365 和 Office 365 計畫，但各項計畫中可用的功能可能會有所不同。 若要查看每個計劃之可用功能的詳細資訊，請參閱個別的服務描述或連絡轉銷商或 Microsoft 銷售代表以取得詳細資訊。 <br/>  許多 Microsoft 365 和 Office 365 方案都具有您可以為訂閱購買的附加元件。 附加元件可為訂閱提供額外的功能。 如需詳細資訊，請參閱 [購買或編輯商務用 Office 365 附加元件](https://support.office.com/article/Buy-or-edit-an-add-on-for-Office-365-for-business-4e7b57d6-b93b-457d-aecd-0ea58bff07a6)。 
...
<sup>1</sup> Azure 資訊保護未包含在內，但能以個別的附加元件形式購買，並且會啟用支援的資訊版權管理 (IRM) 功能。 有些 Azure 資訊保護功能需要訂閱 Microsoft 365 Apps 企業版，但不包括 Microsoft 365 商務基本版、Microsoft 365 商務標準版、Microsoft 365 F1、Microsoft 365 F3、Office 365 E1、Office 365 A1 或 Office 365 F3。<br/>
<sup>2</sup>若要深入瞭解 Microsoft 365 和 Office 365 計畫包含哪些 Azure 資訊保護功能，請參閱[Azure 資訊保護](https://azure.microsoft.com/services/information-protection/)。<br/>
<sup>3</sup> Office 365 E5 和 Microsoft 365 E5 包含電話系統和音訊會議。 若要實作通話方案需要購買額外的方案 (國內或國際)。<br/>
<sup>4</sup> 包含 2 GB 的儲存體。 <br/>
<sup>5</sup>包括 Exchange Online 方案1。 <br/>
<sup>6</sup>包括 Exchange Online 方案2。 <br/>
<sup>7</sup>包括 Exchange Online 方案1加上補充功能。 <br/>
<sup>8</sup>包括 Exchange Online Kiosk。 <br/>
<sup>9</sup>包含具有基本用戶端限制的商務用 Skype 線上方案2。 <br/>
<sup>10</sup>包括商務用 Skype 線上方案2，但沒有任何用戶端限制。 <br/>
<sup>11</sup>包括商務用 Skype Online Plan 1 加上補充功能。 <br/>
