...
| 從 Office 365 管理安全性群組 | 是 | 是 | 是 | 是 | 是 | 是 |
...
| 依重要性分組顯示郵件符合 DLP 原則的數目 | 否 | 否 | 否 | 否 | 是 | 否 |
...
<sup>17</sup> Microsoft 365 中的審計可讓組織在 Microsoft 365 中，透過不同的服務深入查看多種類型的已審計活動。 使用 [安全性與 &amp; 合規性中心](./office-365-securitycompliance-center.md) 審核記錄搜尋，以查看組織中的使用者和系統管理員活動。 您也可以使用[Office 365 管理活動 API](/office/office-365-management-api/office-365-management-activity-api-reference) ，從統一的審計記錄檔中取得事件。 當使用者或系統管理員執行已審核的活動時，會產生一個審計記錄，並將其儲存在客戶組織的審計記錄檔中。 審計記錄保留的時間長度 (及可搜尋的審計記錄) 取決於客戶的 Office 365 或 Microsoft 365 企業版訂閱，以及指派給特定使用者的授權類型。
...
| [商務用 Skype](../office-applications-service-description/office-applications.md#skype-for-business) | 是 | 是 | 是 | 是<sup>4</sup> | 是<sup>4</sup> | 是<sup>4</sup> | 是<sup>4</sup> | 是 | 是<sup>4</sup> |
| [Microsoft InfoPath](../office-applications-service-description/office-applications.md#microsoft-infopath) | 否 | 否 | 否 | 否 | 否 | 否 | 否 | 否 | 否 |
| [Windows 10 App](../office-applications-service-description/office-applications.md#windows-10-apps) | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 否 |
| [Office 365 的 Mac 版 Office](https://support.office.com/article/A07A593D-B383-4906-A6C1-962D5543ED57) | 否 | 是 | 否 | 否 | 否 | 是 | 否 | 是 | 否 |
| 適用于 Android 的 Microsoft Office 應用程式 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 |
| Microsoft Office iOS 應用程式 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 |
...
| [適用于 Android 15 的 Office Mobile](../office-applications-service-description/office-applications.md#office-mobile-for-android) <sup> </sup> | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 | 是 |
...
| 用戶端推送部署 | 是 | 是 | 是 | 是 | 是 | 是 | 否 | 是 | 否 |
| 內部部署 Exchange 的用戶端支援 | 是 | 是 | 是 | 是 | 否 | 是 | 否 | 是 | 否 |
| 內部部署 SharePoint 的用戶端支援 | 是 | 是 | 是 | 是 | 否 | 是 | 否 | 是 | 否 |
| 軟體更新的控制 | 是 | 是 | 是 | 是 | 否 | 是 | 否 | 是 | 否 |
...
<br/>網頁的<sup>10</sup> Visio 目前是由世紀運作的 Office 365 預覽。 如需有關 web Visio 的詳細資訊，請參閱[web 服務說明的 Visio](../visio-online-service-description/visio-online-service-description.md)。
...
| Office 365 郵件加密 | 否 | 否 | 否 | 否 | 是<sup>15</sup> | 否 |
| S/MIME | 是 | 是 | 是 | 是 | 是 | 是 |
| 就地保留與訴訟暫止 | 否 | -- | 否 | 否 | 是 | 否 |
...
| 通用連絡人卡片 | 是 | 是 | 是 | 是 | 是 | 是 |
| 社交網路的連絡人連結 | 是<sup>11</sup> | 是<sup>11</sup> | 是<sup>11</sup> | 是<sup>11</sup> | 是<sup>11</sup> | 是<sup>11</sup> |
| 資源信箱 | 是 | 是 | 是 | 是 | 是 | 是 |
| 會議室管理 | 是 | 是 | 是 | 是 | 是 | 是 |
| 外出回覆 | 是 | 是 | 是 | 是 | 是 | 是 |
...
|[報告 Outlook 的郵件增益集](/microsoft-365/security/office-365-security/enable-the-report-message-add-in)|是|是|
...
| BCS：外部清單 | 否 | 否 | 否 | 否 | 是 | 否 |
| BCS: OData connector | 否 | 否 | 否 | 否 | 是 | 否 |
| BCS：設定檔頁面 | 否 | 否 | 否 | 否 | 否 | 否 |
| BCS：豐富型用戶端整合 | 否 | 否 | 否 | 否 | 否 | 否 |
| BCS: Secure Store Service | 否 | 否 | 否 | 否 | 是 | 否 |
| BCS: Tenant-level external data log | 否 | 否 | 否 | 否 | 是 | 否 |
...
| SharePoint 市集 | 否 | 否 | 否 | 否 | 否 | 否 |
| SharePoint 2010 工作流程 (.NET 3.5) | 否 | 否 | 否 | 否 | 否 | 否 |
| SharePoint 2010 工作流程 (現成可用) | 否 | 否 | 否 | 否 | 否 | 否 |
| SharePoint 2013 和 SharePoint 2016 工作流程 | 是 | 否 | 是 | 是<sup>4</sup> | 是<sup>4</sup> | 是 |
...
| 搜尋網頁組件 | 否 | 否 | 否 | 否 | 是 | 否 |
| 跨網站發佈 | 否 | 否 | 否 | 否 | 是 | 否 |
| WCM：設計者工具 | 是 | 否 | 是 | 是 | 是 | 是 |
| 多面向導覽 | 否 | 否 | 否 | 否 | 無<sup>7</sup> | 否 |
| 圖像轉譯 | 是 | 否 | 是 | 否 | 否 | 否 |
| WCM：受管理的導覽 | 是 | 否 | 是 | 是 | 是 | 是 |
| WCM：手機與裝置轉譯 | 是 | 否 | 是 | 是 | 是 | 是 |
| WCM：多個網域 | 否 | 否 | 否 | 否 | 否 | 否 |
| WCM：建議 | 是 | 否 | 是 | 是 | 是 | 是 |
...
| 計算量值和成員 | 否 | 否 | 否 | 否 | 是 | 否 |
| 資料連線庫 | 否 | 否 | 否 | 否 | 是 | 否 |
| Decoupled PivotTables and PivotCharts | 否 | 否 | 否 | 否 | 是 | 否 |
| Excel Services | 否 | 否 | 否 | 否 | 否 | 否 |
| 欄位清單和欄位支援 | 否 | 否 | 否 | 否 | 是 | 否 |
| 篩選器增強功能 | 否 | 否 | 否 | 否 | 是 | 否 |
| 篩選搜尋 | 否 | 否 | 否 | 否 | 是 | 否 |
| PerformancePoint Services | 否 | 否 | 否 | 否 | 否 | 否 |
| PerformancePoint 服務 (PPS) 儀表板遷移 | 否 | 否 | 否 | 否 | 否 | 否 |
| Power BI | 否 | 否 | 否 | 否 | 否 | 否 |
| Power View for Excel in SharePoint | 否 | 否 | 否 | 否 | 否 | 否 |
| SharePoint 中 Excel 的 Power Pivot | 否 | 否 | 否 | 否 | 否 | 否 |
| Quick Explore | 否 | 否 | 否 | 否 | 是 | 否 |
| 計分卡 &amp; 儀表板 | 否 | 否 | 否 | 否 | 否 | 否 |
| SQL Server Reporting Services (SSRS) Integrated Mode | 否 | 否 | 否 | 否 | 否 | 否 |
| 時程表交叉分析篩選器 | 否 | 否 | 否 | 否 | 否 | 否 |
...
| 自訂實體擷取 | 否 | 否 | 否 | 否 | 否 | 否 |
| Deep links | 是 | 是 | 是 | 是 | 是 | 是 |
| Event-based relevancy | 是 | 是 | 是 | 是 | 是 | 是 |
| 專業知識搜尋 | 是 | 是 | 是 | 是 | 是 | 是 |
| Extensible content processing | 否 | 否 | 否 | 否 | 否 | 否 |
| Graphical refiners | 是 | 是 | 是 | 是 | 是 | 是 |
| Hybrid search | 是 | 是 | 是 | 是 | 是 | 是 |
| Manage search schema | 是 | 否 | 是 | 是 | 是 | 是 |
| 內部部署的搜尋索引 | 否 | 否 | 否 | 否 | 否 | 否 |
| Phonetic name matching | 是 | 是 | 是 | 是 | 是 | 是 |
| 查詢規則增加升級的查詢結果 | 是 | 否 | 是 | 是 | 是 | 是 |
| Query rules—advanced actions | 否 | 否 | 否 | 否 | 是 | 否 |
| Query spelling correction | 是 | 否 | 是 | 是 | 是 | 是 |
| Query suggestions | 是 | 否 | 是 | 是 | 是 | 是 |
| 查詢節流 | 是 | 否 | 是 | 是 | 是 | 是 |
| 游標暫留預覽 | 是 | 是 | 是 | 是 | 是 | 是 |
| Ranking models | 否<sup>5</sup> | 否 | 否 | 否<sup>5</sup> | 否<sup>5</sup> | 否<sup>5</sup> |
| 精簡器 | 是 | 是 | 是 | 是 | 是 | 是 |
| RESTful Query API/Query OM | 是 | 是 | 是 | 是 | 是 | 是 |
| 結果來源 | 是 | 是 | 是 | 否 | 否 | 否 |
| 搜尋連接器架構 | 否 | 否 | 否 | 否 | 否 | 否 |
| Search results sorting | 是 | 是 | 是 | 是 | 是 | 是 |
| 垂直式搜尋：「交談」 | 是 | 是 | 是 | 是 | 是 | 是 |
...
| 行動裝置連線 | 否 | 是<sup>13</sup> | 是<sup>12</sup> | 是<sup>12</sup> | 是<sup>12</sup> | 是<sup>12</sup> |
| 多種語系使用者介面 | 是<sup>13</sup> | 是<sup>13</sup> | 是<sup>13</sup> | 是<sup>13</sup> | 是<sup>13</sup> | 是<sup>13</sup> |
| 我的任務 | 是 | 否 | 是 | 是 | 是 | 是 |
| OOTB 網頁組件 | 是 | 否 | 是 | 是 | 是 | 是 |
| 權限管理 | 是 | 是 | 是 | 是 | 是 | 是 |
| 小組網站的專案功能 | 是 | 否 | 是 | 是 | 是 | 是 |
| Project site template | 是 | 否 | 是 | 是 | 是 | 是 |
| 專案摘要網頁組件 | 是 | 否 | 是 | 是 | 是 | 是 |
| 專案工作區 | 是 | 否 | 是 | 是 | 是 | 是 |
| SharePoint 清單 | 是 | 否 | 是 | 是 | 是 | 是 |
| SharePoint 功能區 | 是 | 否 | 是 | 是 | 是 | 是 |
| 文件庫 | 是 | 否 | 是 | 是 | 是 | 是 |
| Task list | 是 | 否 | 是 | 是 | 是 | 是 |
| 小組網站：拖曳 &amp; 放下 | 是 | 否 | 是 | 是 | 是 | 是 |
| 小組筆記本 | 是 | 否 | 是 | 是 | 是 | 是 |
| 小組網站：簡化的存取 | 是 | 否 | 是 | 是 | 是 | 是 |
| 網站設計 | 是 | 否 | 是 | 是 | 是 | 是 |
| 網站主題 (變更外觀)  | 是 | 否 | 是 | 是 | 是 | 是 |
| 網站使用頁面 | 否 | 否 | 否 | 否 | 否 | 否 |
...
| 社群 | 否 | 否 | 否 | 否 | 否 | 否 |
| 公司摘要 | 否 | 否 | 否 | 否 | 否 | 否 |
| 使用 Yammer 進行文件交談 | 否 | 否 | 否 | 否 | 否 | 否 |
| 追蹤 | 否 | 否 | 否 | 否 | 否 | 否 |
| 微網誌 | 否 | 否 | 否 | 否 | 否 | 否 |
| 新聞摘要 | 是 | 否 | 是 | 是 | 是 | 否 |
| 單鍵共用 | 否 | 否 | 否 | 否 | 否 | 否 |
| 人員、網站、文件建議 | 否 | 否 | 否 | 否 | 否 | 否 |
| 個人網站 | 否 | 否 | 否 | 否 | 否 | 否 |
| 相片與顯示狀態 | 否 | 否 | 否 | 否 | 否 | 否 |
| 設定檔 | 否 | 否 | 否 | 否 | 否 | 否 |
| Ratings | 否 | 否 | 否 | 否 | 否 | 否 |
| Shared with Me | 否 | 否 | 否 | 否 | 否 | 否 |
| 使用 SharePoint 社交) 的網站摘要 (傳統小組網站 | 否 | 否 | 否 | 否 | 否 | 否 |
| 商務用 OneDrive | 是 | 是 | 是 | 是 | 是 | 是<sup>2</sup> |
| Tag profiles | 否 | 否 | 否 | 否 | 否 | 否 |
| 與 Outlook 整合的工作 | 是 | 是 | 是 | 是 | 是 | 否 |
| 趨勢標記 | 否 | 否 | 否 | 否 | 否 | 否 |
| Wikis | 否 | 否 | 否 | 否 | 否 | 否 |
| Yammer | 否 | 否 | 否 | 否 | 否 | 否 |
...
<sup>1</sup>若要使用資料夾同步處理，您必須將 Office 2013 或更新版本 (Standard 或 Professional edition) 或包含 Office 應用程式的訂閱。 Office 365 商務基本版、Office 365 Enterprise E1 以及 Office 365 教育版 方案並未包含 Office 桌面應用程式訂閱。 不過，如果您已安裝 Office 2013 或更新版本，並訂閱上述其中一個方案，就可以使用資料夾同步處理。
...
<br/><sup>8</sup> Kiosk users cannot create Office documents using live tiles. 若要建立檔，kiosk 使用者必須先選取 [**新增**]，然後選取檔案類型-Word 檔、Excel 活頁簿、PowerPoint 簡報、OneNote 筆記本或 Excel 調查-從 [**建立新** 檔案] 功能表中，以 SharePoint 執行此動作。
...
<br/><sup>11</sup> Kiosk 帳戶具有有限的商務用 OneDrive 功能。 Kiosk customers can use the OneDrive for Business folder sync client application to sync team site document libraries with a shared computer and access documents offline. But kiosk accounts do not include a OneDrive for Business Personal Site, so they do not benefit from a OneDrive for Business personal library with 1 TB or 5 TB of online storage.
...
<br/><sup>14</sup> Visio 網頁消費 (view 功能) 可供免費使用。 Visio 網頁版建立和編輯功能需要授權。 如需有關 web Visio 的詳細資訊，請參閱[web 服務說明的 Visio](../visio-online-service-description/visio-online-service-description.md)。
<br/><sup>15</sup> K1 的使用者可以在混合式設定中存取 SharePoint Server，但 Office 365 K1 不包含 CAL 許可權來存取伺服器;這些權利必須另外購買。
...
| 商務用 Skype Windows 市集應用程式 | 是 | 是 | 是 | 是 | 是 | 否 |
...
| 連絡人卡片設定 | 是 | 是 | 是 | 是 | 是 | 否 |
| 我的圖片設定 | 是 | 是 | 是 | 是 | 是 | 否 |
| 我的圖片：URL 相片體驗 | 否 | 否 | 否 | 否 | 否 | 否 |
| 連絡人清單設定 | 是 | 是 | 是 | 是 | 是 | 否 |
| 整合聯絡資料儲存 | 否 | 否 | 否 | 否 | 否 | 否 |
| 通訊錄搜尋 | 是 | 是 | 是 | 是 | 是 | 否 |
...
| 當前發言者視訊 | 是 | 是 | 是 | 是 | 是 | 否 |
| H.264 編碼和解碼 | 是 | 是 | 是 | 是 | 是 | 否 |
| 多方視訊 | 是 | 是 | 是 | 是 | 是 | 否 |
| 所有出席者的高畫質視訊或影像 | 是 | 是 | 是 | 是 | 是 | 否 |
| 簡報者控制項 | 是 | 是 | 是 | 是 | 是 | 否 |
| 所選參與者檢視 | 是 | 是 | 是 | 是 | 是 | 否 |
| OneNote 共用 | 是 | 是 | 是 | 是 | 是 | 否 |
| 臨機操作和排程 Web 會議 | 是 | 是 | 是 | 是 | 是 | 否 |
| 透過音訊會議的商務用 Skype 會議撥入 (第一方) | 否 | 否 | 否 | 否 | 否 | 否 |
| 透過認證音訊會議提供者 (ACP 商務用 Skype 會議撥入)  | 是 | 是 | 是 | 是 | 是 | 否 |
| PowerPoint 共用 | 是 | 是 | 是 | 是 | 是 | 否 |
| 檔案傳輸 | 是 | 是 | 是 | 是 | 是 | 否 |
| 白板和注釋 | 是 | 是 | 是 | 是 | 是 | 否 |
| PowerPoint 上傳 | 是 | 是 | 是 | 是 | 是 | 否 |
| 輪詢 | 是 | 是 | 是 | 是 | 是 | 否 |
| 用戶端錄製和播放 | 是 | 是 | 是 | 是 | 是 | 否 |
| 伺服器端錄製和播放 | 否 | 否 | 否 | 否 | 否 | 否 |
| 會議大廳 | 是 | 是 | 是 | 是 | 是 | 否 |
| Skype 會議廣播 | 否 | 否 | 否 | 否 | 否 | 否 |
| 使用商務用 Skype Web App 的 Skype 會議的 Guest 存取權 | 是 | 是 | 是 | 是 | 是 | 否 |
| 在 Outlook 中排程商務用 Skype 會議 | 是 | 是 | 是 | 是 | 是 | 否 |
| 在 Outlook 中代表他人排程商務用 Skype 會議 (委派) | 是 | 是 | 是 | 是 | 是 | 否 |
| 使用 web 排程器排程商務用 Skype 會議 | 是 | 是 | 是 | 是 | 是 | 否 |
...
| 接聽/啟始通話 | 否 | 否 | 否 | 否 | 否 | 否 |
| 通話委派 | 否 | 否 | 否 | 否 | 否 | 否 |
| 來電轉接和同時響鈴 | 否 | 否 | 否 | 否 | 否 | 否 |
| 通話記錄 | 否 | 否 | 否 | 否 | 否 | 否 |
| 通話保留/擷取 | 否 | 否 | 否 | 否 | 否 | 否 |
| 通話駐留 | 否 | 否 | 否 | 否 | 否 | 否 |
| 來電轉接 (盲目、諮詢和行動) | 否 | 否 | 否 | 否 | 否 | 否 |
| 來電者識別碼 | 否 | 否 | 否 | 否 | 否 | 否 |
| 插撥功能 | 否 | 否 | 否 | 否 | 否 | 否 |
| 呼叫保留 | 否 | 否 | 否 | 否 | 否 | 否 |
| PC、Mac 和行動用戶端 | 否 | 否 | 否 | 否 | 否 | 否 |
| 切換裝置 | 否 | 否 | 否 | 否 | 否 | 否 |
| 特殊響鈴 | 否 | 否 | 否 | 否 | 否 | 否 |
| 請勿打擾路由 | 否 | 否 | 否 | 否 | 否 | 否 |
| 緊急電話 - 靜態位置 | 否 | 否 | 否 | 否 | 否 | 否 |
| 緊急電話 - 動態位置 | 否 | 否 | 否 | 否 | 否 | 否 |
| 企業行事曆來電路由 | 否 | 否 | 否 | 否 | 否 | 否 |
| 分機撥號 | 否 | 否 | 否 | 否 | 否 | 否 |
| 群組來電接聽 | 否 | 否 | 否 | 否 | 否 | 否 |
| 搜尋群組/來電佇列與處理 | 否 | 否 | 否 | 否 | 否 | 否 |
| 整合式撥號鍵台 | 否 | 否 | 否 | 否 | 否 | 否 |
| 依位置路由 | 否 | 否 | 否 | 否 | 否 | 否 |
| 來電保留音樂 | 否 | 否 | 否 | 否 | 否 | 否 |
| 撥出 DID 控制 | 否 | 否 | 否 | 否 | 否 | 否 |
| 私人線路 | 否 | 否 | 否 | 否 | 否 | 否 |
| 合格的 IP 桌上型電話 | 否 | 否 | 否 | 否 | 否 | 否 |
| 共用的線路外觀 | 否 | 否 | 否 | 否 | 否 | 否 |
| Skype 和同盟通話 | 否 | 否 | 否 | 否 | 否 | 否 |
| 團隊通話 | 否 | 否 | 否 | 否 | 否 | 否 |
| 視訊通話監視器 | 否 | 否 | 否 | 否 | 否 | 否 |
| 語音信箱 | 否 | 否 | 否 | 否 | 否 | 否 |
| [通話方案](../skype-for-business-online-service-description/skype-for-business-online-features.md#calling-plans) (國內通話方案，含有必要的附加元件購買)  | 否 | 否 | 否 | 否 | 否 | 否 |
...
| 用戶端版本控制 | 是 | 是 | 是 | 是 | 是 | 否 |
| IM 內容封存 | 否<sup>2</sup> | 否<sup>2</sup> | 否<sup>2</sup> | 否<sup>2</sup> | 否 | 否 |
| 會議內容封存 | 否<sup>2</sup> | 否<sup>2</sup> | 否<sup>2</sup> | 否<sup>2</sup> | 否 | 否 |
...
| 與 Exchange Online 的整合通訊互通性 | 否 | 否 | 否 | 否 | 否 | 否 |
| 網頁版 Outlook 互通性 | 是 | 是 | 是 | 是 | 是 | 否 |
| 與 Exchange Server 的封存互通性 | 否 | 否 | 否 | 否 | 否 | 否 |
...
| Microsoft 365 系統管理中心中的商務用 Skype Online 報告 | 是 | 是 | 是 | 是 | 是 | 否 |
...
|伺服器端錄製和播放|否|否|
|會議大廳|否|是|
|使用商務用 Skype Web 應用程式對商務用 Skype 會議的來賓存取權|否|是|
...
<sup>1</sup> The Skype for Business (Lync) client is supported for use with these subscription options, but it is not included.  所有客戶皆可使用 Lync 2013 Basic。 Lync Basic 桌面用戶端是在本機安裝的應用程式，可針對包含 商務用 Skype Online 的 Office 365 方案，提供目前狀態、立即訊息和會議功能。 Office 365 專業增強版和 Office 365 企業版 E3 包含完整商務用 Skype (Lync) 應用程式，其中包含其他功能（包括高級電話語音支援、封存 &amp; 相容性功能）。 必須為每個使用者指派商務用 Skype Online 授權。 如需有關 Lync 基本功能的詳細資訊，請參閱[桌面用戶端比較表](/lyncserver/lync-server-2013-desktop-client-comparison-tables) (英文)。
...
## <a name="outlook-features-for-ios-and-android"></a>iOS 和 Android 的 Outlook 功能

由世紀運作的 Office 365 同時支援適用于 Android iOS 和 Outlook 的 Outlook。

不支援下列行動裝置功能：

- 僅限 Android 支援商務用 OneDrive () 
- 人員 & 行事曆搜尋
- 會議室搜尋 & 預約
- 地點卡片
...
|[在 Project 伺服器或 Project Online 上發佈專案](../project-online-service-description/project-publishing.md#publish-projects-on-project-server-or-project-online)|否|是|是|是|否|
|[在 SharePoint 上儲存 Project 的 MPP 檔案](../project-online-service-description/project-publishing.md#save-a-project-mpp-file-on-sharepoint)|否|是|是|是|否|
