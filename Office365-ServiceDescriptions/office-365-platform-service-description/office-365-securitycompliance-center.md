...
|[資訊管理](https://docs.microsoft.com/microsoft-365/compliance/manage-information-governance)<sup>1</sup>  |是<sup>11</sup>   |是<sup>11</sup>   |是<sup>11</sup>   |是   |是   |是   |是<sup>11</sup>   |
|[高級資訊管理](https://docs.microsoft.com/office365/securitycompliance/labels)<sup>2</sup>  |否   |否   |否   |否   |否   |是   |否   |
|[內容搜尋](https://docs.microsoft.com/office365/securitycompliance/search-for-content)  |是   |是   |是   |是   |是   |是   |是   |
...
|[通訊合規性 (監察原則) ](https://docs.microsoft.com/office365/securitycompliance/supervision-policies)  |否   |否   |否   |否   |否   |是   |否   |
...
<sup>8</sup> 所有包含基本審核 (方案的審計記錄檔（E5) 除外）會保留90天。 因為 E5 包含高級審計，所以審計記錄會保留最多一年。 此外，您也可以使用 [Office 365 管理活動 API](https://docs.microsoft.com/office/office-365-management-api/office-365-management-activity-api-reference) ，從統一的審計記錄檔中取得事件。
...
<sup>13</sup> 不包含以機器教學為基礎的標籤 (trainable 的分類器) 。
