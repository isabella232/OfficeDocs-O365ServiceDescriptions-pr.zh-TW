...
- **計畫的維護事件：** 規劃維護是針對基礎結構和軟體應用程式的定期 Microsoft 發起服務更新。 規劃的維護通知會告知客戶可能會影響 Microsoft 服務功能的服務運作。 在 Microsoft 365 系統管理中心的郵件中心，所有的計畫維護都有超過五天后，客戶便會收到通知。 根據區域時區的情形，Microsoft 一般會規劃維護，以瞭解服務的使用頻率為最低。 
...
服務事件發生時，Microsoft 會辨識及時、鎖定目標且正確的通訊對客戶很重要。 Microsoft 會透過更新 Microsoft 365 系統管理中心上的承租人特定服務健康情況儀表板 (SHD) 通知系統管理員。 服務事件更新是以每小時的節奏提供，或者，如果需要不同的節奏，就會在 SHD 通訊發佈中加以說明。 
...
- **線上問題追蹤：** 客戶需得知自己的問題已在解決中，也須能即時追蹤解決進度。 Microsoft 365 系統管理中心提供單一的 web 介面以支援。 客戶可使用入口網站來新增並監控服務請求，以及接收來自 Microsoft 支援團隊的回覆。 
