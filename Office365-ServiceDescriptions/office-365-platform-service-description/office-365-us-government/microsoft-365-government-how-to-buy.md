...
1. 完成並提交適用于 [gcc](https://azure.microsoft.com/global-infrastructure/government/request/) 或 [gcc](https://azure.microsoft.com/global-infrastructure/government/request/) 的表單，以驗證貴組織的資格。
