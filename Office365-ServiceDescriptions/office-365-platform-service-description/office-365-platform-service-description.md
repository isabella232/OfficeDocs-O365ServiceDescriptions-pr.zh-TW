...
若要跨方案比較功能，請參閱[強大的工具來支援您的企業](https://go.microsoft.com/fwlink/?LinkID=799177&amp;clcid=0x409); 若要瞭解更詳細的功能清單，請參閱[Microsoft 365 和 Office 365 服務說明](../office-365-service-descriptions-technet-library.md)底下的相關服務說明。
...
- 如需由世紀運作之 Office 365 的資訊，請從 [[由世紀運作的 office 365](office-365-operated-by-21vianet.md) ] 頁面開始。 
    
- 如需 Office 365 Germany 的資訊，請從 [Office 365 Germany](office-365-germany.md) 頁面開始參閱。 
    
## <a name="office-365-plans"></a>Office 365 計劃

我們在多種計劃中提供 Office 365 以盡可能滿足組織的需求。 如需不同計畫的相關資訊，包括獨立計畫選項及從一個計畫移至另一個計畫的資訊，請參閱[Office 365 plan options](office-365-plan-options.md)。
  
若要瞭解大量授權，請參閱[授權條款和檔](https://go.microsoft.com/fwlink/?linkid=848696)。
  
## <a name="microsoft-365-and-office-365-plans-and-pricing-for-nonprofits"></a>適用于非營利組織的 Microsoft 365 和 Office 365 方案和價格

針對適用于非營利組織的 Microsoft 365 和 Office 365 方案的組織，這些方案包含與對應商務方案完全相同的功能（例如，Office 365 E5 for 非營利組織包含與 Office 365 E5 相同的功能）。 這些對等方案之間的唯一差別是您支付的價格。 如需適用于非營利組織的 Microsoft 365 和 Office 365 方案的詳細資訊，請參閱[比較 Microsoft 365 與 office 365 提供的非營利組織](https://go.microsoft.com/fwlink/?LinkID=627221)和[生產力解決方案以取得非營利組織](https://go.microsoft.com/fwlink/?LinkID=786641)。
  
## <a name="system-requirements"></a>系統需求

如需適用于企業、教育和政府組織的每月訂閱型服務的系統 365 365 需求，請參閱[microsoft 365 和 Office 資源的系統需求](https://products.office.com/office-system-requirements/#Office365forBEG)。
...
多地理位置可讓單一組織跨越多個 Office 365 資料中心地理位置，並可讓您在所選擇的地理位置中，以每位使用者的身分存放 Exchange Online 和 OneDrive 的商務資料。 
...
- 非盈利性：[比較 Microsoft 365 和 Office 365 提供的非營利組織](https://go.microsoft.com/fwlink/?LinkID=733237)
...
|Microsoft MyAnalytics<sup>20</sup>  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |否  <br/> |
|Microsoft Planner  <br/> |是  <br/> |否  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |
|Microsoft PowerApps  <br/> |是  <br/> |否  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是<sup>12</sup> <br/> | 
|Microsoft Project for web <sup>23</sup> <br/> |是 <br/> |否 <br/>|是 <br/> |是 <br/> |是 <br/> |是 <br/> | 是 <br/> |
|Microsoft StaffHub  <br/> |否  <br/> |否  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |
|Microsoft Stream  <br/> |是  <br/> |否  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是<sup>17</sup> <br/> |
...
|OneNote 課程筆記本  <br/> |否  <br/> |否  <br/> |否  <br/> |否  <br/> |否  <br/> |是<sup>14</sup> <br/> |否  <br/> |
|Microsoft Kaizala<sup>18</sup> <br/> |是  <br/> |否  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是 <br/> |
...
|從 Microsoft 365 或使用 Windows PowerShell<sup>3</sup>中刪除帳戶並重設使用者密碼 <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |
...
|Azure Active Directory 服務<sup>21</sup>  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |
...
|使用 Microsoft 365 報表 web 服務建立您自己的報表  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |是  <br/> |
...
|客戶金鑰<sup>15</sup> <br/> |否  <br/> |否  <br/> |否  <br/> |否  <br/> |否  <br/> |是  <br/> |否  <br/> |
|Advanced eDiscovery<sup>16</sup> <br/> |否  <br/> |否  <br/> |否  <br/> |否  <br/> |否  <br/> |是  <br/> |否  <br/> |
...
<br/><sup>2</sup> Azure 資訊保護未包含在內，但能以個別的附加元件形式購買，並且會啟用支援的資訊版權管理（IRM）功能。 部分 Azure 資訊保護功能需要訂閱 Microsoft 365 應用程式，但不包含在 Microsoft 365 Business Basic、Microsoft 365 Business Standard、Office 365 企業版 E1、Office 365 教育版或 Office 365 Enterprise F3 中。 隨附于 Microsoft 365 應用程式的 Office 用戶端應用程式也支援完整的 Azure 資訊保護（方案1）功能。
<br/><sup>3</sup>如果使用與本機 active directory 的目錄同步處理，則必須使用本機 active directory，而365非使用 Windows PowerShell 的 Azure Active directory 模組來刪除帳戶或變更密碼。 
<br/><sup>4</sup>若要瞭解如何為使用者設定自助密碼管理原則，請參閱[使用安全性資訊重設工作或學校密碼](https://azure.microsoft.com/documentation/articles/active-directory-manage-passwords/)。 
...
<br/><sup>7</sup>在[Microsoft Secure 得分](https://securescore.office.com)安全性頁面上提供。 需要系統管理員許可權。 如需詳細資訊，請參閱[Microsoft 安全分數](https://docs.microsoft.com/microsoft-365/security/mtp/microsoft-secure-score)。 
...
<br/><sup>10 個</sup>microsoft 團隊可在 Microsoft 365 商務版、Microsoft 365 商務版、Office 365 企業版（E1、E3、E5、F3）和 Office 365 教育版方案中取得。 
<br/><sup>11</sup>在 Office 365 Enterprise F3 中，Office 365 影片只限于查看（沒有發佈或共用）。 
<br/><sup>12</sup>在 Office 365 Enterprise F3 中，PowerApps 僅限消耗（不是發佈或共用）。 
<br/><sup>13</sup>在 Office 365 Enterprise F3 中，流程只會限制在使用中，每位使用者每個月的執行數目限制為750。 
<br/><sup>14</sup>只有 Office 365 教育版方案（包括 Office 365 E5 教育版）提供。 It is not available in Office 365 Enterprise E5. 
<br/><sup>15</sup>如需詳細資訊，請參閱[Service Encryption with Customer Key](https://support.office.com/article/Controlling-your-data-in-Office-365-using-Customer-Key-f2cd475a-e592-46cf-80a3-1bfb0fa17697?ui=en-US&amp;rs=en-US&amp;ad=US)。 
<br/><sup>16</sup>美國和西歐（荷蘭）地區支援的高級 eDiscovery。 (來自加拿大和亞太地區的客戶資料會匯出至美國。 來自歐洲、中東和非洲的客戶資料會匯出到西歐 [荷蘭]。)
<br/>僅適用于 Microsoft Stream 的<sup>17</sup>消耗：沒有發佈或共用。
<br/><sup>18</sup>從2019年5月開始，backfilled Office 365 和 Microsoft 365 的現有合格 SKUs 會與 Kaizala Pro 一起使用。 從2019年6月1日開始，Kaizala Pro 將會包含在所有合格的 Office 365 和 Microsoft 365 SKUs 中。
<br/><sup>19</sup>可用為免費附加元件。 如需詳細資訊，請參閱[取得 Microsoft 預約存取權](https://support.office.com/article/Get-access-to-Microsoft-Bookings-5382dc07-aaa5-45c9-8767-502333b214ce)。
<br/><sup>20</sup>如需詳細資訊，請參閱[MyAnalytics 方案和環境](https://docs.microsoft.com/workplace-analytics/myanalytics/overview/plans-environments)。
<br/><sup>21</sup>包含[azure active directory 定價](https://azure.microsoft.com/pricing/details/active-directory/)頁面上的**Office 365 應用程式**欄中所述的 Azure Active Directory 功能。 您必須加入 Azure Active Directory Plan 1 或 Plan 2、Enterprise Mobile Security 或 Microsoft 365 E3 或 E5 以取得 premium Azure AD 功能。<br/>
<sup>22</sup>簡報電子郵件會自動提供給 Exchange Online 的所有使用者。 如需詳細資訊，請參閱[設定簡報電子郵件](https://docs.microsoft.com/Briefing/be-admin)。<br>
<sup>23</sup>如需詳細資訊，請參閱[Microsoft Project service 描述](../project-online-service-description/project-online-service-description.md)。 使用者被授與 Web 專案的「限制存取」許可權。 這些權力只會限制在 web 應用程式的專案中使用，而且只能用於具有專案方案1、專案方案3或專案方案5授權的承租人。 這些權力不會授與 Power Platform 應用程式或其他資料集、Project Online 桌面用戶端或 Project Online 的存取權。
