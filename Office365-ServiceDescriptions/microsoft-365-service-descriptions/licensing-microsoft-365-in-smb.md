...
Microsoft 365 商務版精品是適用于中小型企業 (SMB) 客戶的 Microsoft 一流產品。 Microsoft 365 商務版特優整合解決方案，結合了具有 **高級安全性** 和 **裝置管理** 功能的 Microsoft 365 **生產力**。
...
|**Office 應用程式** | 在最多5部電腦上安裝 Office + 每位平板電腦 + 5 部 smartphone (Word、Excel、PowerPoint、OneNote、Access) 、Office Online | Business | Business |
...
|**Office 應用程式** | 在最多5部電腦上安裝 Office + 每位平板電腦 + 5 部 smartphone (Word、Excel、PowerPoint、OneNote、Access) 、Office Online | ProPlus | Business |
...
|**Office 應用程式** | 在最多5部電腦上安裝 Office + 每位平板電腦 + 5 部 smartphone (Word、Excel、PowerPoint、OneNote、Access) 、Office Online | Business | Business | ProPlus |
...
|**Office 應用程式** | 在最多5部電腦上安裝 Office + 每位平板電腦 + 5 部 smartphone (Word、Excel、PowerPoint、OneNote、Access) 、Office Online | Business | Business | ProPlus | ProPlus |
...
|**內部部署 CAL 許可權** | ECAL Suite (Exchange、SharePoint、Skype、Windows、Microsoft Endpoint Configuration 管理員、Windows Rights Management)  | 否 | 否 | 是 | 是 |
...
<sup>1</sup> 可讓組織將 Office 的某些設定 (的安全性設定、應用程式設定、Active Directory 漫遊等) 推入公司網路的電腦。
...
<sup>4</sup> 封存來自 Outlook 的電子郵件 &mdash; ，不需要 .pst 檔案 &mdash; ，並設定自動封存或刪除電子郵件的保留原則。 IT 系統管理員可以集中管理 In-Place 封存。
