...
|                                         | 記錄管理：記錄版本設定                           | 可以使用 |
|                                         | 記錄管理：法規記錄 | 在工程處理積壓工作 |
|                                         | 記錄管理：授權強制執行 | 在工程處理積壓工作 |
|                                         | 記錄管理：多階段處置評審 | 在工程處理積壓工作 |
|                                         | 記錄管理：標籤活動瀏覽器         | 在工程處理積壓工作 |
|                                         | 記錄管理： Trainable 分類器         | 在工程處理積壓工作 |
| **有問必答風險管理**             | 客戶加密箱                                | 可以使用            |
...
|                                         | Advanced eDiscovery： CJK/雙位元組字元支援                              | 在工程處理積壓工作 |
|                                         | Advanced eDiscovery： Graph APIs                              | 在工程處理積壓工作 |
|                                         | Advanced eDiscovery： Microsoft 規範中心擴充支援，可在 SharePoint 和 OneDrive 進行商務用回收站中搜尋及匯出專案                              | 在工程處理積壓工作 |
|                                         | Advanced eDiscovery：非 Office 365 攝取和處理 (例如，OCR)                               | 在工程處理積壓工作 |
|                                         | Advanced eDiscovery：支援小組反應                              | 在工程處理積壓工作 |
|                                         | 基本審核                              | 可以使用 |
