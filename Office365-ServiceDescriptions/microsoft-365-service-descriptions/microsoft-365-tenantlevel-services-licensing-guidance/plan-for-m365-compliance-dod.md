...
|                                         | 核心電子檔探索：審計                                        | 可以使用              |
|                                         | Advanced eDiscovery：高級處理                                 | 推出中 |
|                                         | Advanced eDiscovery：保管人 to 工作負載對應                                 | 推出中 |
|                                         | Advanced eDiscovery：保管人通訊                                 | 推出中 |
|                                         | Advanced eDiscovery：儀表板                   | 推出中 |
|                                         | Advanced eDiscovery：電子郵件執行緒                                          | 推出中 |
|                                         | Advanced eDiscovery： Export (下載、匯出、新增至另一個評審集)                                | 推出中 |
|                                         | Advanced eDiscovery：篩選                 | 推出中 |
|                                         | Advanced eDiscovery：小組私人通道訊息的法律封存                                         | 推出中 |
|                                         | Advanced eDiscovery：接近重複識別                                         | 推出中 |
|                                         | Advanced eDiscovery：非 Office 365 攝取                                      | 推出中 |
|                                         | Advanced eDiscovery：預測編碼                                       | 推出中 |
|                                         | Advanced eDiscovery：已使用載入檔案處理匯出                   | 推出中 |
|                                         | Advanced eDiscovery：密文                        | 推出中 |
|                                         | Advanced eDiscovery：複查集                                     | 推出中 |
|                                         | Advanced eDiscovery：回顧和批註                             | 推出中 |
|                                         | Advanced eDiscovery：搜尋字詞報告                        | 推出中 |
|                                         | Advanced eDiscovery：從 OneDrive 和 SharePoint 線上 (新式附件支援連結內容)                         | 推出中 |
|                                         | Advanced eDiscovery：標記                              | 推出中 |
|                                         | Advanced eDiscovery：小組反應支援                              | 推出中 |
|                                         | Advanced eDiscovery：承租人報告                              | 推出中 |
|                                         | Advanced eDiscovery：主題                              | 推出中 |
|                                         | Advanced eDiscovery： Viewer                              | 推出中 |
|                                         | Advanced eDiscovery： Microsoft 規範中心的 Yammer 高級 eDiscovery                              | 推出中 |
|                                         | Advanced ediscovery：針對高級電子檔探索的 CJK/雙位元組支援                              | 在開發 |
|                                         | 基本審核                              | 可以使用 |
|                                         | 高級審核：對重要事件的存取 (例如，mailitemsaccessed)                               | 推出中 |
|                                         | 高級審核：增加管理活動 API 的頻寬                              | 推出中 |
|                                         | 高級審核：記錄保留 (1 年)                               | 推出中 |
