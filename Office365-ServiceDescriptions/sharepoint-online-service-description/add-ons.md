...
## <a name="azure-provisioned-apps-access-services"></a>Azure 佈建的應用程式： Access Services
...
## <a name="azure-provisioned-apps-custom-code-in-azure-lightweight-web-role-lwr"></a>Azure 佈建的應用程式： 自訂程式碼中 Azure 輕量型網路角色 (LWR)
