...
## <a name="content-organizer"></a>Content Organizer
...
將公共網站最佳化以便搜尋，對於和新客戶及回訪客戶的聯繫非常重要。 SharePoint Online 包括內建的 SEO 功能，例如可自訂的 robots.txt 及網頁層級的中繼標記功能，這些都可讓組織可輕鬆微調網站，以達到更好的搜尋結果。
