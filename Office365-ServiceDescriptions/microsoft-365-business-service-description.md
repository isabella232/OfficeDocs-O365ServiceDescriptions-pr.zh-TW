...
---
# <a name="microsoft-365-business-service-description"></a>Microsoft 365 Business 服務說明

Microsoft 365 商務是整合式的解決方案，將一起引進具有進階安全性和裝置管理功能可協助保護您的企業的 Office 365 最佳的類別生產力。.此服務描述說明計劃選項和功能。如需 Office 365 的詳細資訊，請參閱[Office 365 服務說明](office-365-service-descriptions-technet-library.md)。
  
## <a name="feature-availability-across-office-365-business-premium-and-microsoft-365-business-plans"></a>不同 Office 365 企業進階版和 Microsoft 365 商務計劃中可用的功能

下表列出 Office 365 企業進階版和 Microsoft 365 商務計劃的平台功能。
  
若要檢視可用的功能不同 Office 365 計劃，請參閱[Office 365 平台服務說明](office-365-platform-service-description/office-365-platform-service-description.md)。
...
|威脅情報  <br/> |否  <br/> |否  <br/> |
|[符合性 [ServiceDesc]](office-365-platform-service-description/compliance-servicedesc.md) <br/> |**Office 365 商務進階版** <br/> |**Microsoft 365 商務版 ** <br/> |
...
|||
|:-----|:-----|
|**Windows 10 管理功能**Microsoft 365 商務容易管理裝置。設定您的 Microsoft 365 商務租用戶時您選取 [應用程式保護及裝置組態設定。這些設定會決定套用的原則會自動裝置加入 Azure Active Directory 時。Windows 10 Pro 管理功能包括：<br/> |**Microsoft 365 商務版 ** <br/> |
|使用 Windows 自動駕駛儀上簡化的部署  <br/> |是  <br/> |
|訂閱啟用  <br/> |是  <br/> |
|組織控制的裝置] 畫面上閒置時間  <br/> |是  <br/> |
|組織控制使用者存取應用程式中的 Microsoft 存放區的  <br/> |是  <br/> |
|組織控制的使用者存取 Cortana  <br/> |是  <br/> |
|組織 Windows 控制項秘訣和使用 microsoft 的廣告  <br/> |是  <br/> |
|自動保持在最新的 Windows 10 裝置  <br/> |是  <br/> |
